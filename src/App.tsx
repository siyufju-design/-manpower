...
const duties: Duty[] = [
  ...
  },
 {
  ...
  }, 
  {
    ...
    location: "宗輔室",
    people: ["碩誠", "慧玟", "庭葰", "圓庭", "惟謙", "珊淇", "宥伶", "詩璇", "婧蓉", "欣愉", "彥儒", "杏昀", "采伃", "曉琳", "宣亞", "文伶"],
    task: "分區回報",
  ...
  },
  {
    ...
    people: ["珊淇"],
    task: "開幕式場前場控",
    detail: "接待貴賓入座（同雪老師：向貴賓說明時間提醒方式；和學副、院長說明最後可能只要揮手致意）；放好提示牌（自備手錶）；確認所有貴賓致詞結束時間點、合照時間點（約9 : 25）；和專題演講（一）主持人（楊老師）說明提醒牌時間",
  },
  {
    id: "0425-0820-４",
    day: "0425",
  ...
  },
  {
    ...
    location: "一樓國際會議廳",
    people: ["碩誠", "慧玟", "文伶", "少杰", "晏緹", "珊淇"],
    task: "開幕式進行",
    detail: "司儀主持開幕、串接貴賓致詞、致贈禮物（場規攝影拍照）、控制節奏；場控舉牌；引導遞麥、維持走道與協助合照動線。",
  },
  {
    id: "0425-0927-1",
    day: "0425",
